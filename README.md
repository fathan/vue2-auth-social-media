# Vue 2 Auth Social Media
> Auth Social Media with Vue, Vuex, Vue-Router
...
## Demo here
for demo you can open the following demo link: [Demo](https://fathan.github.io/vue2-auth-social-media/).
